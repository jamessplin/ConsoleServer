...
def main():
    ...
    if args.start and args.end:
        ...
        if getattr(args, "enable_second_sshd", False):
            ...
            # Write main sshd drop-in config for first half
            config_text = build_config(primary_start, primary_end, group=group, address_family=getattr(args, "address_family", "any"))
            write_dropin(config_text, dropin_path, print_only=False, dry_run=args.dry_run)
            # Write secondary sshd config for second half
            create_secondary_sshd(
                secondary_start, secondary_end,
                address_family=getattr(args, "address_family", "any"),
            ...
            config_text = build_config(args.start, args.end, group=group, address_family=getattr(args, "address_family", "any"))
            write_dropin(config_text, dropin_path, print_only=False, dry_run=args.dry_run)
        # Reload sshd
